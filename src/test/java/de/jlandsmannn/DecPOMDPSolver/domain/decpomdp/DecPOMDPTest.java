...
class DecPOMDPTest {
  ...
  @BeforeEach
  void setUp() {
    var agent1 = new TestAgent("A1", Action.setOf("A1-A1", "A1-A2"), Observation.setOf("A1-O1", "A1-O2"));
    var agent2 = new TestAgent("A2", Action.setOf("A2-A1", "A2-A2"), Observation.setOf("A2-O1", "A2-O2"));
